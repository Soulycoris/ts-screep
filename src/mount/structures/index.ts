// import { structureWithMemory } from "../../utils/setting";
// import ControllerExtension from "./controller";
// import { LinkConsole, LinkExtension } from "./link";
// import ExtractorExtension from "./extractor";
// import StorageExtension from "./storage";
// import NukerExtension from "./nuker";
// import { PowerSpawnConsole, PowerSpawnExtension } from "./powerSpawn";
// import { ObserverConsole, ObserverExtension } from "./observer";
// import { FactoryConsole, FactoryExtension } from "./factory";
// import { TerminalConsole, TerminalExtension } from "./terminal";
...
export default (): void => {
  ...
  // 挂载所有拓展
  assignMap.forEach(protos => assignPrototype(protos[0].prototype, protos[1].prototype));
};
